...
class SettingController extends Controller
{
    ...
    public function update(Request $request)
    {
        $data = $request->validate([
            ...
            'header_menu_font_size' => ['nullable','integer','min:11','max:24'],
            ...
            'footer_border_color' => ['nullable','string','max:60'],
    ...
    private function settingsMap(): array
    {
        ...
        return [
            ...
            'header_menu_font_size' => (int)(optional($rows->get('header_menu_font_size'))->value ?? 14),
            'contact_email' => $rows['contact_email']->value ?? null,
            'contact_phone' => $rows['contact_phone']->value ?? null,
            'whatsapp_number' => optional($rows->get('whatsapp_number'))->value ?? null,
            ...
            'footer_border_color' => optional($rows->get('footer_border_color'))->value ?? null,
