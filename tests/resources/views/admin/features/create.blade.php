...
<body>
  ...
  <div class="wrap">
    ...
    <form method="POST" action="{{ route('admin.features.store') }}" enctype="multipart/form-data">
      ...
      <input id="icon" type="text" name="icon" value="{{ old('icon') }}" placeholder="Pick or type…" list="iconlist">
      ...
      <input id="icon_image_url" type="text" name="icon_image_url" value="{{ old('icon_image_url') }}" placeholder="https://...">
