...
INSERT INTO `services` (`id`, `icon`, `title`, `description`, `image_url`, `checklist`, `sort_order`, `created_at`, `updated_at`) VALUES
(1, NULL, 'still doesn’t show the admin', 'still doesn’t show the admin', NULL, '[]', 0, '2025-12-31 03:06:40', '2025-12-31 03:06:40'),
(2, NULL, 'still doesn’t show the admin', 'still doesn’t show the admin', NULL, '[]', 0, '2025-12-31 03:07:16', '2025-12-31 03:07:16'),
(3, '🚚', 'Air Freight', 'Air Freight', NULL, '[]', 0, '2025-12-31 03:11:38', '2025-12-31 03:11:38'),
(4, NULL, 'Create Service', 'Create Service', '/uploads/services/service_20251231_084640_1b253042.jpeg', '[\"Create Service\"]', 0, '2025-12-31 03:16:51', '2025-12-31 03:16:51');
