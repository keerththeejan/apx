...
<head>
  ...
  <style>
    ...
    * { box-sizing: border-box }
    ...
    .nav { max-width: 1200px; margin: 0 auto; padding: 10px 24px; display:flex; align-items:center; justify-content:space-between }
    .brand { display:flex; align-items:center; gap:10px; font-weight:700 }
    .brand small { color: var(--muted); font-weight:600 }
    .links a { color: var(--muted); text-decoration:none; margin-left:22px; font-weight:500 }
    ...
    /* Gallery */
    .gallery { max-width:1200px; margin: 12px auto 0; padding: 0 24px 8px; overflow-x:auto }
    .gallery-track { display:flex; gap:16px; min-width:1200px }
...
<body>
  <header class="topbar">
    <div class="nav">
      <div class="brand">
        ...
        <small>Safe Transportation & Logistics</small>
      </div>
      <div class="links">
        <a href="/">Home</a>
  ...
  <section class="why" aria-label="Why we are the best">
    <div class="wrap">
      <h2>Why we are considered the best in business</h2>
      <p class="lead">Decentralized trade, direct transport, high flexibility and secure delivery.</p>
      <div class="why-grid">
        <div class="benefits">
          <div class="benefit"><span class="dot"></span><div><h4>Decentralized Trade</h4><p>Streamlined hubs maximize speed.</p></div></div>
          <div class="benefit"><span class="dot"></span><div><h4>Direct Transport</h4><p>Fewer touches, faster delivery.</p></div></div>
        </div>
        <div class="glass">
          <img src="https://images.unsplash.com/photo-1532074205216-d0e1f4b87368?q=80&w=1000&auto=format&fit=crop" alt="Document inspection">
        </div>
        <div class="benefits">
          <div class="benefit"><span class="dot"></span><div><h4>Highly Flexible</h4><p>Adaptable capacity and routes.</p></div></div>
          <div class="benefit"><span class="dot"></span><div><h4>Secure Delivery</h4><p>Tamper-evident packaging, QA.</p></div></div>
        </div>
      </div>
    </div>
  </section>
  ...
  <div class="quote-wrap">
    <div class="quote">
      <div class="best">
        <small>Transport & Logistics Services</small>
        <h3>We are the best</h3>
        <p>We’re a worldwide logistics supplier — we uphold industry and exchange the world.</p>
        <ul>
          <li>Reaching Worship An Online Family</li>
          <li>Reaching Worship An Online Family</li>
        </ul>
        <div class="media">
          <img src="https://images.unsplash.com/photo-1606400081740-9a8f7303fdd2?q=80&w=400&auto=format&fit=crop" alt="Global logistics">
          <div>
            <strong>Leading global logistic</strong>
            <div style="color:#94a3b8">and transport agency since <b>1990</b></div>
          </div>
        </div>
      </div>
      <div class="form">
        ...
        <form class="card-form" action="#" method="post">
          ...
          <div class="row">
            <input class="input" type="text" name="city" placeholder="Delivery City">
            <select class="select" name="freight">
          ...
          <div class="chips">
            <label class="chip"><input type="checkbox" name="fragile"> Fragile</label>
            <label class="chip"><input type="checkbox" name="express"> Express delivery</label>
            <label class="chip"><input type="checkbox" name="insurance"> Insurance</label>
          </div>
          <div class="row">
  ...
  <section class="gallery" aria-label="Latest logistics posts">
    <div class="gallery-track">
      ...
      <div class="gcard"><img src="https://images.unsplash.com/photo-1552465011-b4e21bf6e79a?q=80&w=800&auto=format&fit=crop" alt="Port"><div class="meta"><span class="d">06<br>Feb</span><span class="t">Port</span></div></div>
      <div class="gcard"><img src="https://images.unsplash.com/photo-1586521995568-39e81bba5b1d?q=80&w=800&auto=format&fit=crop" alt="Parcel"><div class="meta"><span class="d">14<br>Dec</span><span class="t">Parcel</span></div></div>
      <div class="gcard"><img src="https://images.unsplash.com/photo-1500530855697-b586d89ba3ee?q=80&w=800&auto=format&fit=crop" alt="Transport"><div class="meta"><span class="d">25<br>Dec</span><span class="t">Transport</span></div></div>
    </div>
  </section>
    ...
    <div class="helpgrid">
      ...
      <div class="getquote">
        ...
        <form class="form2" action="#" method="post">
          <div class="row2">
            <input class="input" type="text" name="q_name" placeholder="Your Name">
            <input class="input" type="email" name="q_email" placeholder="Your Email">
          </div>
          <div class="row2">
            <input class="input" type="text" name="q_subject" placeholder="Subject">
          </div>
          <div class="row2">
            <select class="select" name="q_service">
          ...
          <div class="row2">
            <textarea class="textarea" name="q_message" placeholder="Your Message"></textarea>
          </div>
          <button type="submit" class="submit">Send Message</button>
        </form>
      </div>
  ...
  <footer class="footer">
    © <span id="year"></span> Parcel Transport. All rights reserved.
  </footer>
